...
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/vue/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/@nuxt/devalue/dist/devalue.mjs';
import nodemailer from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/nodemailer/lib/nodemailer.js';
import options from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.nuxt/nuxt-mail/options.mjs';
import send$1 from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.nuxt/nuxt-mail/send.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/node_modules/@unhead/shared/dist/index.mjs';
...
const _HVfqS6FLsa = (function(nitro) {
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _52It38dque = defineNitroPlugin(async (nitroApp) => {
...
const _nDEevH = defineEventHandler(async (e) => {
...
const _YKPK0h = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _xXvL3e = defineEventHandler(async (e) => {
...
const _AJC32N = defineEventHandler(async (e) => {
...
const _dbZnwp = defineEventHandler(async (e) => {
...
const _BzjVwQ = defineEventHandler(async event => {
  try {
...
const _8JBMVC = lazyEventHandler(() => {
...
const handlers = [
  ...
  { route: '/__sitemap__/debug.json', handler: _xXvL3e, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _AJC32N, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _dbZnwp, lazy: false, middleware: false, method: undefined },
  { route: '/mail/send', handler: _BzjVwQ, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _8JBMVC, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KCX6Yz, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/KoszegiJew/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
